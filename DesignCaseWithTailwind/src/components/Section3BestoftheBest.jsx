    ...
    return (
        <section className=" bg-[#0f172a] text-white ">
            <div className="container mx-auto">
                <div className="flex flex-col gap-20 p-20 max-lg:px-4 max-lg:py-12 mx-auto overflow-hidden">
                    <div className="flex justify-between items-center  max-lg:flex-col max-lg:gap-8 ">
                        <h1 className="font-extrabold text-[56px] max-lg:text-3xl ">The best of the best</h1>
