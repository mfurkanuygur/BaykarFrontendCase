...
const Section3BestoftheBest = () => {
    return (
        <section className="bg-[#0f172a] text-white flex flex-col gap-20 p-20 max-md:px-4 max-md:py-12 mx-auto overflow-hidden">
            <div className="flex justify-between items-center  max-md:flex-col max-md:gap-8 ">
                <h1 className="font-extrabold text-[56px] max-md:text-3xl ">The best of the best</h1>
            ...
            <div className="relative mx-auto ">
                ...
                <div className="relative grid grid-cols-3 max-md:grid-cols-1 gap-20 max-md:gap-10">
                    {BestProducts.map(card => (
                        <div key={card.id} className="bg-[#0f172a] rounded-lg  drop-shadow-[0_35px_35px_rgba(255,255,255,0.15)]  ">
                            <img src={card.source} alt={card.title} className="w-full rounded-t-lg" />
